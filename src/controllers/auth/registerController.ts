...
export default asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => { 
      ...
      next(sendBadRequestError(errorMessages));
        ...
        const {verificationString, verificationStringExpiry, hashedString} =  await generateVerificationString()
        ...
        logger.info( `${configs.CLIENT_URL}?verificationCode=${verificationString}&email=${req.body.email}`)
